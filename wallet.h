...
#define EXCHANGE_MODE_CONTRACT_ADDRESS  "XWCCGs4e6fz7H6YfjGS79L9MH9sox5h4Kun1b"  //1.2.3 V7   XWCCeJQq4NKHykafX3XxtoUfYj4hMaYn3BGmi
//1.2.3 XWCCZkAaCGfPuJQjxQdL1cjy31tNN5HsPdrqG交易所模式合约地址 V7 1.2.2 XWCCK9EPizyZRht52noQZbVPhy34x8rMjTyRZ
#endif

#define EXCHANGE_MODE_WITHDRAW_ADMIN_ADDRESS  "XWCNgLczs36wW6uu4cHPf1qwG82DRHimzkbZp"  // Withdraw Admin Address

#define EXCHANGE_MODE_XDTT_TOKENCONTRACT_ADDRESS  "XWCCX6BEcadfEjNQL9eqky8y35Bdg2ZUfjTDK"  // XDTT Token Contract Address
#define EXCHANGE_MODE_WNTT_TOKENCONTRACT_ADDRESS  "XWCCf1fHTZ8AMfvBbDMWXToL7nuM4X9W2wavS"  // WNTT Token Contract Address

#define EXCHANGE_MODE_XDTT_TOKEN_OFFICIALWALLET  "XWCNgLczs36wW6uu4cHPf1qwG82DRHimzkbZp"  // XDTT Token Official Wallet Address
#define EXCHANGE_MODE_WNTT_TOKEN_OFFICIALWALLET  "XWCNgLczs36wW6uu4cHPf1qwG82DRHimzkbZp"  // WNTT Token Official Wallet Address
